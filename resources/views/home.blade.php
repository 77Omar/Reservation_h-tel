...
<div class="container">
    ...
    <br><br>
    <div> <a class="btn btn-primary"   href="/typechambre"><h1><h1><h1>Typechambre</h1></h1></h1></a>
				...
				<div class="col-lg-40 p-b-30">
					<div class="t-center">
						<span class="tit2 t-center"> 
							...
							<h1>Les chambres de l'hôtel Golden<h1>
						</span>
		...
		<div class="container">
            ...
            <div class="portfolio-items">
                <div class="portfolio-item designing">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="{{asset('images/portfolio/008.jpg')}}" alt="">
                        <div class="portfolio-info"> 
                            <a class="preview" href="{{asset('images/portfolio/008.jpg')}}" rel="prettyPhoto"><i class="fa fa-eye"></i></a>
                        </div>
                    </div>
                </div><!--/.portfolio-item-->
    ...
    <div> <a class="btn btn-primary"   href="/employer"><h1><h1><h1>Employers</h1></h1></h1></a></div>
		<div class="container">
            ...
            <div class="portfolio-items">
                <div class="portfolio-item designing">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="{{asset('images/portfolio/005.jpg')}}" alt="">
                        <div class="portfolio-info"> 
                            <a class="preview" href="{{asset('images/portfolio/005.jpg')}}" rel="prettyPhoto"><i class="fa fa-eye"></i></a>
                        </div>
                    </div>
                </div><!--/.portfolio-item-->
